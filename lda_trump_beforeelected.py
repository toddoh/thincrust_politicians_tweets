...
for source, filepath in filepath_dict.items():
    ...
    for line in reader:
        ...
        dt_2016electiondate = dateutil.parser.parse('11/06/2016')
        if dt_tweetdate > dt_2016electiondate:
            continue
...
tweets_df.to_csv('./result_topic_cluster_' + tweets_source + '-beforeelected.csv', sep='\t', index=False)
tweets_df.to_json('./result_topic_cluster_' + tweets_source + '-beforeelected.json', orient='records')

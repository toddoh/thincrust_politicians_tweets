...
filepath_dict = {'biden': './tweetdata/biden_10242007-06012019.csv'}
print('Dough: Init r11-0613_2019-biden')
...
'''
tweets_init = preprocess_tweets(None, '11/03/2008')
tweets_type = 'before2008VPElected'
'''
tweets_init = preprocess_tweets('11/04/2008', None)
tweets_type = '2008VP-2019'
...
stop_words.extend(['biden', 'joe', 'joebiden', 'facebook', 'album', 'rt', 'pm', 'yesterday', 'afternoon', 'tbt', 'tonight', 'click', 'join', 'day', 'news', 'just', 'great', 'live', 'thank', 'people', 'today', 'watch', 'posted', 'photo', 'photos']) #custom per-type
...
df_dominant_topic.to_csv('./output/biden/result_lda_full_' + tweets_source + '-' + tweets_type + '.csv', sep='\t', index=False)
df_dominant_topic.to_json('./output/biden/result_lda_full_' + tweets_source + '-' + tweets_type + '.json', orient='records')
print('Dough: Saved full dataset with topic data in ', ' ./output/biden/result_lda_full_' + tweets_source + '-' + tweets_type + '.csv')
...
sent_topics_sorteddf_mallet.to_csv('./output/biden/result_lda_top_' + tweets_source + '-' + tweets_type + '.csv', sep='\t', index=False)
sent_topics_sorteddf_mallet.to_json('./output/biden/result_lda_top_' + tweets_source + '-' + tweets_type + '.json', orient='records')
print('Dough: Saved top 10 document dataset in ', ' ./output/biden/result_lda_top_' + tweets_source + '-' + tweets_type + '.csv')
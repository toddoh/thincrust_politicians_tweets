...
filepath_dict = {'sanders': './tweetdata/sanders_05012009-06012019.csv'}
print('Dough: Init r11-0613_2019-sanders')
...
'''
tweets_init = preprocess_tweets(None, '04/29/2015')
tweets_type = 'before2016campaign'
'''
tweets_init = preprocess_tweets('04/30/2015', None)
tweets_type = '2016campaign-2019'
...
stop_words.extend(['sen', 'sanders', 'bernie', 'sander', 'join', 'news', 'ow', 'just', 'great', 'live', 'thank', 'people', 'today', 'watch']) #custom per-type
...
df_dominant_topic.to_csv('./output/sanders/result_lda_full_' + tweets_source + '-' + tweets_type + '.csv', sep='\t', index=False)
df_dominant_topic.to_json('./output/sanders/result_lda_full_' + tweets_source + '-' + tweets_type + '.json', orient='records')
print('Dough: Saved full dataset with topic data in ', ' ./output/sanders/result_lda_full_' + tweets_source + '-' + tweets_type + '.csv')
...
sent_topics_sorteddf_mallet.to_csv('./output/sanders/result_lda_top_' + tweets_source + '-' + tweets_type + '.csv', sep='\t', index=False)
sent_topics_sorteddf_mallet.to_json('./output/sanders/result_lda_top_' + tweets_source + '-' + tweets_type + '.json', orient='records')
print('Dough: Saved top 10 document dataset in ', ' ./output/sanders/result_lda_top_' + tweets_source + '-' + tweets_type + '.csv')